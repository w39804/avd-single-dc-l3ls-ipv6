...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF2 | Vlan4094 | 2001:db8:3:2::2 | Port-Channel3 |
...
| Ethernet8 | L2_dc1-leaf2c_Ethernet1 | *trunk | *11-12,21-22,31-32,3401-3402 | *- | *- | 8 |
...
router bgp 65102
   ...
   neighbor MLAG-IPv6-UNDERLAY-PEER description dc1-leaf2b
   ...
   neighbor 2001:db8:2:4::1 description dc1-spine1_Ethernet3
   neighbor 2001:db8:2:5::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:5::1 remote-as 65100
   neighbor 2001:db8:2:5::1 description dc1-spine2_Ethernet3
   neighbor 2001:db8:4:2::2 peer group MLAG-IPv6-UNDERLAY-PEER
   neighbor 2001:db8:4:2::2 description dc1-leaf2b_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.3
      neighbor 2001:db8:4:2::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::2 description dc1-leaf2b_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.3
      neighbor 2001:db8:4:2::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::2 description dc1-leaf2b_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF13
      rd 10.255.1.3:13
      ...
      router-id 10.255.1.3
      neighbor 2001:db8:4:2::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::2 description dc1-leaf2b_Vlan3012
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
