...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.111/24 | 172.20.20.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_leaf01_Ethernet4 | *trunk | *11-12,21-22,31-32,3401-3402 | *- | *- | 1 |
| Ethernet2 | L2_leaf02_Ethernet4 | *trunk | *11-12,21-22,31-32,3401-3402 | *- | *- | 1 |
...
!
interface Ethernet1
   description L2_leaf01_Ethernet4
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_leaf02_Ethernet4
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_DC1_L3_POD1_Port-Channel4 | trunk | 11-12,21-22,31-32,3401-3402 | - | - | - | - | - | - |
...
interface Port-Channel1
   description L2_DC1_L3_POD1_Port-Channel4
   no shutdown
