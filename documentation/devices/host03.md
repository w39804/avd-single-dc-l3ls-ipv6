...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management0 | oob_management | oob | MGMT | 3fff:172:20:20::113/24 | - |
...
interface Management0
   ...
   no shutdown
   vrf MGMT
   ipv6 address 3fff:172:20:20::113/24
```
...
!
interface Ethernet1
   description L2_leaf05_Ethernet4
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_leaf06_Ethernet4
   no shutdown
   channel-group 1 mode active
```
...
| --------- | --- | ------------ | ---------------------- | ------------------------ | -------------- | ------------------- | ----------------- | ----------- | ------------ |
| Vlan11 | VRF10 | 2602:0010:FF:11::203/64 | - | - | - | - | - | - | - |
| Vlan21 | VRF11 | 2001:db8:21::203/48 | - | - | - | - | - | - | - |
...
interface Vlan11
   ...
   no shutdown
   vrf VRF10
   ipv6 address 2602:0010:FF:11::203/64
!
interface Vlan21
   description vrf-irb-vlan21
   no shutdown
   vrf VRF11
   ipv6 address 2001:db8:21::203/48
```
