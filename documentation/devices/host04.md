...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management0 | oob_management | oob | MGMT | 3fff:172:20:20::114/24 | - |
...
interface Management0
   ...
   no shutdown
   vrf MGMT
   ipv6 address 3fff:172:20:20::114/24
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_leaf07_Ethernet4 | *trunk | *11-12,21-22,31-32,3401-3402 | *- | *- | 1 |
| Ethernet2 | L2_leaf08_Ethernet4 | *trunk | *11-12,21-22,31-32,3401-3402 | *- | *- | 1 |
...
!
interface Ethernet1
   description L2_leaf07_Ethernet4
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_leaf08_Ethernet4
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_DC1_L3_POD4_Port-Channel4 | trunk | 11-12,21-22,31-32,3401-3402 | - | - | - | - | - | - |
...
interface Port-Channel1
   description L2_DC1_L3_POD4_Port-Channel4
   no shutdown
...
| --------- | --- | ------------ | ---------------------- | ------------------------ | -------------- | ------------------- | ----------------- | ----------- | ------------ |
| Vlan11 | VRF10 | 2602:0010:FF:11::204/64 | - | - | - | - | - | - | - |
| Vlan21 | VRF11 | 2001:db8:21::204/48 | - | - | - | - | - | - | - |
...
interface Vlan11
   ...
   no shutdown
   vrf VRF10
   ipv6 address 2602:0010:FF:11::204/64
!
interface Vlan21
   description vrf-irb-vlan21
   no shutdown
   vrf VRF11
   ipv6 address 2001:db8:21::204/48
```
