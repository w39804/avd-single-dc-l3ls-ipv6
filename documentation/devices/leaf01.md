...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 3fff:172:20:20::101/64 | 3fff:172:20:20::1 |
...
interface Management0
   ...
   vrf MGMT
   ipv6 enable
   ipv6 address 3fff:172:20:20::101/64
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_host01_Ethernet1 | *trunk | *11-12,21-22,31-32 | *4092 | *- | 4 |
...
!
interface Ethernet4
   description SERVER_host01_Ethernet1
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | SERVER_host01_Bond1 | trunk | 11-12,21-22,31-32 | 4092 | - | - | - | 4 | - |
...
interface Port-Channel4
   description SERVER_host01_Bond1
   no shutdown
...
| 2001:db8:4::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF12 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65101
   ...
   vrf VRF12
      ...
      router-id 10.255.1.1
      neighbor 2001:db8:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4::2 description leaf02_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
