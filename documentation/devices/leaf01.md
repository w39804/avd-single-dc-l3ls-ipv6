...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_POD1 | Vlan4094 | 2001:db8:3::2 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_dc1-leaf01-server1_PCI1 | *trunk | *11-12,21-22 | *4092 | *- | 4 |
| Ethernet5 | MLAG_leaf02_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_leaf02_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_spine01_Ethernet1 | - | 2001:db8:2::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_spine02_Ethernet1 | - | 2001:db8:2:1::2/64 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_spine01_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_spine02_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description SERVER_dc1-leaf01-server1_PCI1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_leaf02_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf02_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | SERVER_dc1-leaf01-server1_Bond1 | trunk | 11-12,21-22 | 4092 | - | - | - | 4 | - |
| Port-Channel5 | MLAG_leaf02_Port-Channel5 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel4
   description SERVER_dc1-leaf01-server1_Bond1
   no shutdown
...
interface Port-Channel5
   description MLAG_leaf02_Port-Channel5
   no shutdown
   switchport mode trunk
...
| Loopback13 | DIAG_VRF_VRF13 | VRF13 | 10.255.13.1/32 |
...
| Vlan3012 | VRF13 | 2001:db8:4::1/64 | - | - | - | - | - | - | - |
...
| 2001:db8:2:1::1 | 65100 | default | - | Inherited from peer group IPv6-UNDERLAY-PEERS | Inherited from peer group IPv6-UNDERLAY-PEERS | - | - | - | - | - | - |
| 2001:db8:2::1 | 65100 | default | - | Inherited from peer group IPv6-UNDERLAY-PEERS | Inherited from peer group IPv6-UNDERLAY-PEERS | - | - | - | - | - | - |
| 2001:db8:4::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF13 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.255.1.1:10011 | 10011:10011 | - | - | learned |
| 12 | 10.255.1.1:10012 | 10012:10012 | - | - | learned |
| 21 | 10.255.1.1:10021 | 10021:10021 | - | - | learned |
| 22 | 10.255.1.1:10022 | 10022:10022 | - | - | learned |
| 31 | 10.255.1.1:10031 | 10031:10031 | - | - | learned |
| 32 | 10.255.1.1:10032 | 10032:10032 | - | - | learned |
| 3401 | 10.255.1.1:13401 | 13401:13401 | - | - | learned |
| 3402 | 10.255.1.1:13402 | 13402:13402 | - | - | learned |
...
router bgp 65101
   ...
   neighbor MLAG-IPv6-UNDERLAY-PEER description leaf02
   ...
   neighbor 2001:db8:2:1::1 description spine02_Ethernet1
   neighbor 2001:db8:2::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2::1 remote-as 65100
   neighbor 2001:db8:2::1 description spine01_Ethernet1
   neighbor 2001:db8:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
   neighbor 2001:db8:4::2 description leaf02_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.1
      neighbor 2001:db8:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4::2 description leaf02_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.1
      neighbor 2001:db8:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4::2 description leaf02_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF13
      rd 10.255.1.1:13
      ...
      router-id 10.255.1.1
      neighbor 2001:db8:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4::2 description leaf02_Vlan3012
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
ip address virtual source-nat vrf VRF13 address 10.255.13.1
```
