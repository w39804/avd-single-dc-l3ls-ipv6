...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 3fff:172:20:20::102/64 | 3fff:172:20:20::1 |
...
interface Management0
   ...
   vrf MGMT
   ipv6 enable
   ipv6 address 3fff:172:20:20::102/64
```
...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_POD1 | Vlan4094 | 2001:db8:3::1 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_host01_Ethernet2 | *trunk | *11-12,21-22 | *4092 | *- | 4 |
| Ethernet5 | MLAG_leaf01_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_leaf01_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_spine01_Ethernet2 | - | 2001:db8:2:2::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_spine02_Ethernet2 | - | 2001:db8:2:3::2/64 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_spine01_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_spine02_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description SERVER_host01_Ethernet2
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_leaf01_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf01_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| Port-Channel5 | MLAG_leaf01_Port-Channel5 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel5
   description MLAG_leaf01_Port-Channel5
   no shutdown
   switchport mode trunk
...
| Loopback10 | DIAG_VRF_VRF10 | VRF10 | 2602:10:ff:10::2/128 |
| Loopback11 | DIAG_VRF_VRF11 | VRF11 | 2602:11:ff::2/128 |
| Loopback12 | DIAG_VRF_VRF12 | VRF12 | 2602:12:ff:12::2/128 |
...
interface Loopback10
   ...
   no shutdown
   vrf VRF10
   ipv6 address 2602:10:ff:10::2/128
!
interface Loopback11
   description DIAG_VRF_VRF11
   no shutdown
   vrf VRF11
   ipv6 address 2602:11:ff::2/128
!
interface Loopback12
   description DIAG_VRF_VRF12
   no shutdown
   vrf VRF12
   ipv6 address 2602:12:ff:12::2/128
```
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.255.1.2:10011 | 10011:10011 | - | - | learned |
| 12 | 10.255.1.2:10012 | 10012:10012 | - | - | learned |
| 21 | 10.255.1.2:10021 | 10021:10021 | - | - | learned |
| 22 | 10.255.1.2:10022 | 10022:10022 | - | - | learned |
| 31 | 10.255.1.2:10031 | 10031:10031 | - | - | learned |
| 32 | 10.255.1.2:10032 | 10032:10032 | - | - | learned |
| 3401 | 10.255.1.2:13401 | 13401:13401 | - | - | learned |
| 3402 | 10.255.1.2:13402 | 13402:13402 | - | - | learned |
...
router bgp 65101
   ...
   neighbor MLAG-IPv6-UNDERLAY-PEER description leaf01
   ...
   neighbor 2001:db8:2:2::1 description spine01_Ethernet2
   neighbor 2001:db8:2:3::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:3::1 remote-as 65100
   neighbor 2001:db8:2:3::1 description spine02_Ethernet2
   neighbor 2001:db8:4::1 peer group MLAG-IPv6-UNDERLAY-PEER
   neighbor 2001:db8:4::1 description leaf01_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.2
      neighbor 2001:db8:4::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4::1 description leaf01_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.2
      neighbor 2001:db8:4::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4::1 description leaf01_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF12
      rd 10.255.1.2:12
      ...
      router-id 10.255.1.2
      neighbor 2001:db8:4::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4::1 description leaf01_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
| -------------- | ----------------------- | ----------------------- |
| VRF10 | - | 2602:10:ff:10::2 |
| VRF11 | - | 2602:11:ff::2 |
| VRF12 | - | 2602:12:ff:12::2 |

### Virtual Source NAT Configuration

```eos
!
ipv6 address virtual source-nat vrf VRF10 address 2602:10:ff:10::2
ipv6 address virtual source-nat vrf VRF11 address 2602:11:ff::2
ipv6 address virtual source-nat vrf VRF12 address 2602:12:ff:12::2
```
