...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_POD2 | Vlan4094 | 2001:db8:3:2::2 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_dc1-leaf03-server1_PCI1 | *trunk | *11-12,21-22 | *4092 | *- | 4 |
| Ethernet5 | MLAG_leaf04_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_leaf04_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_spine01_Ethernet3 | - | 2001:db8:2:4::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_spine02_Ethernet3 | - | 2001:db8:2:5::2/64 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_spine01_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_spine02_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description SERVER_dc1-leaf03-server1_PCI1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_leaf04_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf04_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | SERVER_dc1-leaf03-server1 | trunk | 11-12,21-22 | 4092 | - | - | - | 4 | - |
| Port-Channel5 | MLAG_leaf04_Port-Channel5 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel4
   description SERVER_dc1-leaf03-server1
   no shutdown
...
interface Port-Channel5
   description MLAG_leaf04_Port-Channel5
   no shutdown
   switchport mode trunk
...
| Loopback13 | DIAG_VRF_VRF13 | VRF13 | 10.255.13.3/32 |
...
| Vlan3012 | VRF13 | 2001:db8:4:2::1/64 | - | - | - | - | - | - | - |
...
| 2001:db8:4:2::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF13 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.255.1.3:10011 | 10011:10011 | - | - | learned |
| 12 | 10.255.1.3:10012 | 10012:10012 | - | - | learned |
| 21 | 10.255.1.3:10021 | 10021:10021 | - | - | learned |
| 22 | 10.255.1.3:10022 | 10022:10022 | - | - | learned |
| 31 | 10.255.1.3:10031 | 10031:10031 | - | - | learned |
| 32 | 10.255.1.3:10032 | 10032:10032 | - | - | learned |
| 3401 | 10.255.1.3:13401 | 13401:13401 | - | - | learned |
| 3402 | 10.255.1.3:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 10.255.1.3:10 | connected | - |
| VRF11 | 10.255.1.3:11 | connected | - |
| VRF13 | 10.255.1.3:13 | connected | - |
...
router bgp 65102
   ...
   neighbor MLAG-IPv6-UNDERLAY-PEER description leaf04
   ...
   neighbor 2001:db8:2:4::1 description spine01_Ethernet3
   neighbor 2001:db8:2:5::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:5::1 remote-as 65100
   neighbor 2001:db8:2:5::1 description spine02_Ethernet3
   neighbor 2001:db8:4:2::2 peer group MLAG-IPv6-UNDERLAY-PEER
   neighbor 2001:db8:4:2::2 description leaf04_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.3
      neighbor 2001:db8:4:2::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::2 description leaf04_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.3
      neighbor 2001:db8:4:2::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::2 description leaf04_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF13
      rd 10.255.1.3:13
      ...
      router-id 10.255.1.3
      neighbor 2001:db8:4:2::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::2 description leaf04_Vlan3012
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
ip address virtual source-nat vrf VRF13 address 10.255.13.3
```
