...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_host02_Ethernet1 | *trunk | *11-12,21-22,31-32 | *4092 | *- | 4 |
...
!
interface Ethernet4
   description SERVER_host02_Ethernet1
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | SERVER_host02 | trunk | 11-12,21-22,31-32 | 4092 | - | - | - | 4 | - |
...
| Loopback10 | DIAG_VRF_VRF10 | VRF10 | 2602:10:ff::3/128 |
| Loopback11 | DIAG_VRF_VRF11 | VRF11 | 2602:11:ff::3/128 |
| Loopback12 | DIAG_VRF_VRF12 | VRF12 | 2602:12:ff::3/128 |
...
router bgp 65102
   ...
   vrf VRF12
      ...
      router-id 10.255.1.3
      neighbor 2001:db8:4:2::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::2 description leaf04_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
```eos
!
ipv6 address virtual source-nat vrf VRF10 address 2602:10:ff::3
ipv6 address virtual source-nat vrf VRF11 address 2602:11:ff::3
ipv6 address virtual source-nat vrf VRF12 address 2602:12:ff::3
```
