...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 3fff:172:20:20::104/64 | 3fff:172:20:20::1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_POD2 | Vlan4094 | 2001:db8:3:2::1 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_host02_Ethernet2 | *trunk | *11-12,21-22 | *4092 | *- | 4 |
| Ethernet5 | MLAG_leaf03_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_leaf03_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_spine01_Ethernet4 | - | 2001:db8:2:6::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_spine02_Ethernet4 | - | 2001:db8:2:7::2/64 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_spine01_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_spine02_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description SERVER_host02_Ethernet2
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_leaf03_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf03_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| Port-Channel5 | MLAG_leaf03_Port-Channel5 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel5
   description MLAG_leaf03_Port-Channel5
   no shutdown
   switchport mode trunk
...
| Loopback10 | DIAG_VRF_VRF10 | VRF10 | 2602:10:ff:10::4/128 |
| Loopback11 | DIAG_VRF_VRF11 | VRF11 | 2602:11:ff::4/128 |
| Loopback12 | DIAG_VRF_VRF12 | VRF12 | 2602:12:ff:12::4/128 |
...
interface Loopback10
   ...
   no shutdown
   vrf VRF10
   ipv6 address 2602:10:ff:10::4/128
!
interface Loopback11
   description DIAG_VRF_VRF11
   no shutdown
   vrf VRF11
   ipv6 address 2602:11:ff::4/128
!
interface Loopback12
   description DIAG_VRF_VRF12
   no shutdown
   vrf VRF12
   ipv6 address 2602:12:ff:12::4/128
```
...
router bgp 65102
   ...
   neighbor MLAG-IPv6-UNDERLAY-PEER description leaf03
   ...
   neighbor 2001:db8:2:6::1 description spine01_Ethernet4
   neighbor 2001:db8:2:7::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:7::1 remote-as 65100
   neighbor 2001:db8:2:7::1 description spine02_Ethernet4
   neighbor 2001:db8:4:2::1 peer group MLAG-IPv6-UNDERLAY-PEER
   neighbor 2001:db8:4:2::1 description leaf03_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.4
      neighbor 2001:db8:4:2::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::1 description leaf03_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.4
      neighbor 2001:db8:4:2::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::1 description leaf03_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF12
      rd 10.255.1.4:12
      ...
      router-id 10.255.1.4
      neighbor 2001:db8:4:2::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::1 description leaf03_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
| -------------- | ----------------------- | ----------------------- |
| VRF10 | - | 2602:10:ff:10::4 |
| VRF11 | - | 2602:11:ff::4 |
| VRF12 | - | 2602:12:ff:12::4 |

### Virtual Source NAT Configuration

```eos
!
ipv6 address virtual source-nat vrf VRF10 address 2602:10:ff:10::4
ipv6 address virtual source-nat vrf VRF11 address 2602:11:ff::4
ipv6 address virtual source-nat vrf VRF12 address 2602:12:ff:12::4
```
