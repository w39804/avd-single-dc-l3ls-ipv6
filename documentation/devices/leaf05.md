...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 3fff:172:20:20::105/64 | 3fff:172:20:20::1 |
...
interface Management0
   ...
   vrf MGMT
   ipv6 enable
   ipv6 address 3fff:172:20:20::105/64
```
...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_POD3 | Vlan4094 | 2001:db8:3:4::2 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_host03_Ethernet1 | *trunk | *11-12,21-22 | *4092 | *- | 4 |
| Ethernet5 | MLAG_leaf06_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_leaf06_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_spine01_Ethernet5 | - | 2001:db8:2:8::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_spine02_Ethernet5 | - | 2001:db8:2:9::2/64 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_spine01_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_spine02_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description SERVER_host03_Ethernet1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_leaf06_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf06_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| Port-Channel5 | MLAG_leaf06_Port-Channel5 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel5
   description MLAG_leaf06_Port-Channel5
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:1:5::1/64 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2001:db8:5:5::1/64 |
| Loopback10 | DIAG_VRF_VRF10 | VRF10 | 2602:10:ff:10::5/128 |
| Loopback11 | DIAG_VRF_VRF11 | VRF11 | 2602:11:ff::5/128 |
| Loopback12 | DIAG_VRF_VRF12 | VRF12 | 2602:12:ff:12::5/128 |
...
interface Loopback10
   ...
   no shutdown
   vrf VRF10
   ipv6 address 2602:10:ff:10::5/128
!
interface Loopback11
   description DIAG_VRF_VRF11
   no shutdown
   vrf VRF11
   ipv6 address 2602:11:ff::5/128
!
interface Loopback12
   description DIAG_VRF_VRF12
   no shutdown
   vrf VRF12
   ipv6 address 2602:12:ff:12::5/128
```
...
| Vlan3009 | VRF10 | 2001:db8:4:4::1/64 | - | - | - | - | - | - | - |
| Vlan3010 | VRF11 | 2001:db8:4:4::1/64 | - | - | - | - | - | - | - |
| Vlan3011 | VRF12 | 2001:db8:4:4::1/64 | - | - | - | - | - | - | - |
| Vlan4093 | default | 2001:db8:4:4::1/64 | - | - | - | - | - | - | - |
| Vlan4094 | default | 2001:db8:3:4::1/64 | - | - | - | - | - | - | - |
...
| 2001:db8:2:8::1 | 65100 | default | - | Inherited from peer group IPv6-UNDERLAY-PEERS | Inherited from peer group IPv6-UNDERLAY-PEERS | - | - | - | - | - | - |
| 2001:db8:2:9::1 | 65100 | default | - | Inherited from peer group IPv6-UNDERLAY-PEERS | Inherited from peer group IPv6-UNDERLAY-PEERS | - | - | - | - | - | - |
| 2001:db8:4:4::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4:4::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4:4::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4:4::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF12 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 21 | 10.255.1.5:10021 | 10021:10021 | - | - | learned |
| 22 | 10.255.1.5:10022 | 10022:10022 | - | - | learned |
| 31 | 10.255.1.5:10031 | 10031:10031 | - | - | learned |
| 32 | 10.255.1.5:10032 | 10032:10032 | - | - | learned |
...
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 10.255.1.5:10 | connected | - |
| VRF11 | 10.255.1.5:11 | connected | - |
| VRF12 | 10.255.1.5:12 | connected | - |
...
router bgp 65103
   ...
   neighbor MLAG-IPv6-UNDERLAY-PEER description leaf06
   ...
   neighbor 2001:db8:2:8::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:8::1 remote-as 65100
   neighbor 2001:db8:2:8::1 description spine01_Ethernet5
   neighbor 2001:db8:2:9::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:9::1 remote-as 65100
   neighbor 2001:db8:2:9::1 description spine02_Ethernet5
   neighbor 2001:db8:4:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
   neighbor 2001:db8:4:4::2 description leaf06_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.5
      neighbor 2001:db8:4:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:4::2 description leaf06_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.5
      neighbor 2001:db8:4:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:4::2 description leaf06_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF12
      rd 10.255.1.5:12
      ...
      router-id 10.255.1.5
      neighbor 2001:db8:4:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:4::2 description leaf06_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
| -------------- | ----------------------- | ----------------------- |
| VRF10 | - | 2602:10:ff:10::5 |
| VRF11 | - | 2602:11:ff::5 |
| VRF12 | - | 2602:12:ff:12::5 |

### Virtual Source NAT Configuration

```eos
!
ipv6 address virtual source-nat vrf VRF10 address 2602:10:ff:10::5
ipv6 address virtual source-nat vrf VRF11 address 2602:11:ff::5
ipv6 address virtual source-nat vrf VRF12 address 2602:12:ff:12::5
```
