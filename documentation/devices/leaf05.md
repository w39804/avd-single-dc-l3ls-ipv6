...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.105/24 | 172.20.20.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_dc1-leaf03-server1_iLO | access | 11 | - | - | - |
...
!
interface Ethernet4
   description SERVER_dc1-leaf03-server1_iLO
   no shutdown
...
| Loopback13 | DIAG_VRF_VRF13 | VRF13 | 10.255.13.5/32 |
...
| Vlan3012 | VRF13 | 2001:db8:4:4::1/64 | - | - | - | - | - | - | - |
...
| 2001:db8:4:4::2 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF13 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65103
   ...
   vrf VRF13
      ...
      router-id 10.255.1.5
      neighbor 2001:db8:4:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:4::2 description leaf06_Vlan3012
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
ip address virtual source-nat vrf VRF13 address 10.255.13.5
```
