...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 3fff:172:20:20::107/64 | 3fff:172:20:20::1 |
...
interface Management0
   ...
   vrf MGMT
   ipv6 enable
   ipv6 address 3fff:172:20:20::107/64
```
...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_POD4 | Vlan4094 | 2001:db8:3:6::2 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_host04_Ethernet1 | *trunk | *11-12,21-22 | *4092 | *- | 4 |
| Ethernet5 | MLAG_leaf08_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_leaf08_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_spine01_Ethernet7 | - | 2001:db8:2:c::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_spine02_Ethernet7 | - | 2001:db8:2:d::2/64 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_spine01_Ethernet7
   no shutdown
   mtu 1500
   no switchport
   ipv6 address 2001:db8:2:c::2/64
!
interface Ethernet2
   description P2P_spine02_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description SERVER_host04_Ethernet1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_leaf08_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf08_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | SERVER_host04 | trunk | 11-12,21-22 | 4092 | - | - | - | 4 | - |
| Port-Channel5 | MLAG_leaf08_Port-Channel5 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel5
   description MLAG_leaf08_Port-Channel5
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ------------ |
| Loopback0 | ROUTER_ID | default | 2001:db8:1:7::1/64 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 2001:db8:5:7::1/64 |
| Loopback10 | DIAG_VRF_VRF10 | VRF10 | 2602:10:ff:10::7/128 |
| Loopback11 | DIAG_VRF_VRF11 | VRF11 | 2602:11:ff::7/128 |
| Loopback12 | DIAG_VRF_VRF12 | VRF12 | 2602:12:ff:12::7/128 |
...
interface Loopback10
   ...
   no shutdown
   vrf VRF10
   ipv6 address 2602:10:ff:10::7/128
!
interface Loopback11
   description DIAG_VRF_VRF11
   no shutdown
   vrf VRF11
   ipv6 address 2602:11:ff::7/128
!
interface Loopback12
   description DIAG_VRF_VRF12
   no shutdown
   vrf VRF12
   ipv6 address 2602:12:ff:12::7/128
```
...
| 2001:db8:2:c::1 | 65100 | default | - | Inherited from peer group IPv6-UNDERLAY-PEERS | Inherited from peer group IPv6-UNDERLAY-PEERS | - | - | - | - | - | - |
| 2001:db8:2:d::1 | 65100 | default | - | Inherited from peer group IPv6-UNDERLAY-PEERS | Inherited from peer group IPv6-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 21 | 10.255.1.7:10021 | 10021:10021 | - | - | learned |
| 22 | 10.255.1.7:10022 | 10022:10022 | - | - | learned |
| 31 | 10.255.1.7:10031 | 10031:10031 | - | - | learned |
| 32 | 10.255.1.7:10032 | 10032:10032 | - | - | learned |
...
router bgp 65104
   ...
   neighbor MLAG-IPv6-UNDERLAY-PEER description leaf08
   ...
   neighbor 2001:db8:2:c::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:c::1 remote-as 65100
   neighbor 2001:db8:2:c::1 description spine01_Ethernet7
   neighbor 2001:db8:2:d::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:d::1 remote-as 65100
   neighbor 2001:db8:2:d::1 description spine02_Ethernet7
   neighbor 2001:db8:4:6::2 peer group MLAG-IPv6-UNDERLAY-PEER
   neighbor 2001:db8:4:6::2 description leaf08_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.7
      neighbor 2001:db8:4:6::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:6::2 description leaf08_Vlan3009
...
| -------------- | ----------------------- | ----------------------- |
| VRF10 | - | 2602:10:ff:10::7 |
| VRF11 | - | 2602:11:ff::7 |
| VRF12 | - | 2602:12:ff:12::7 |

### Virtual Source NAT Configuration

```eos
!
ipv6 address virtual source-nat vrf VRF10 address 2602:10:ff:10::7
ipv6 address virtual source-nat vrf VRF11 address 2602:11:ff::7
ipv6 address virtual source-nat vrf VRF12 address 2602:12:ff:12::7
```
