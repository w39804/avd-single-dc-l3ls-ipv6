...
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 3fff:172:20:20::108/64 | 3fff:172:20:20::1 |
...
interface Management0
   ...
   vrf MGMT
   ipv6 enable
   ipv6 address 3fff:172:20:20::108/64
```
...
!
interface Ethernet4
   description L2_host04_Ethernet2
   no shutdown
...
| Vlan3011 | VRF12 | 2001:db8:4:6::2/64 | - | - | - | - | - | - | - |
...
| 2001:db8:4:6::1 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF12 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65104
   ...
   vrf VRF12
      ...
      router-id 10.255.1.8
      neighbor 2001:db8:4:6::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:6::1 description leaf07_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
