...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.108/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_POD4 | Vlan4094 | 2001:db8:3:6::1 | Port-Channel5 |
...
!
mlag configuration
   domain-id DC1_L3_POD4
   local-interface Vlan4094
   peer-address 2001:db8:3:6::1
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_spine01_Ethernet8 | - | 2001:db8:2:e::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_spine02_Ethernet8 | - | 2001:db8:2:f::2/64 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_spine01_Ethernet8
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_spine02_Ethernet8
   no shutdown
   mtu 1500
   no switchport
   ipv6 address 2001:db8:2:f::2/64
!
interface Ethernet5
   description MLAG_leaf07_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf07_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
interface Port-Channel5
   description MLAG_leaf07_Port-Channel5
   no shutdown
...
| Loopback13 | DIAG_VRF_VRF13 | VRF13 | 10.255.13.8/32 |
...
interface Loopback1
   ...
   no shutdown
   ipv6 address 2001:db8:5:7::1/64
!
...
| Vlan3009 | VRF10 | 2001:db8:4:6::2/64 | - | - | - | - | - | - | - |
| Vlan3010 | VRF11 | 2001:db8:4:6::2/64 | - | - | - | - | - | - | - |
| Vlan3012 | VRF13 | 2001:db8:4:6::2/64 | - | - | - | - | - | - | - |
| Vlan4093 | default | 2001:db8:4:6::2/64 | - | - | - | - | - | - | - |
| Vlan4094 | default | 2001:db8:3:6::2/64 | - | - | - | - | - | - | - |
...
| 2001:db8:2:e::1 | 65100 | default | - | Inherited from peer group IPv6-UNDERLAY-PEERS | Inherited from peer group IPv6-UNDERLAY-PEERS | - | - | - | - | - | - |
| 2001:db8:2:f::1 | 65100 | default | - | Inherited from peer group IPv6-UNDERLAY-PEERS | Inherited from peer group IPv6-UNDERLAY-PEERS | - | - | - | - | - | - |
| 2001:db8:4:6::1 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4:6::1 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4:6::1 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
| 2001:db8:4:6::1 | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | VRF13 | - | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | Inherited from peer group MLAG-IPv6-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.255.1.8:10011 | 10011:10011 | - | - | learned |
| 12 | 10.255.1.8:10012 | 10012:10012 | - | - | learned |
| 21 | 10.255.1.8:10021 | 10021:10021 | - | - | learned |
| 22 | 10.255.1.8:10022 | 10022:10022 | - | - | learned |
| 31 | 10.255.1.8:10031 | 10031:10031 | - | - | learned |
| 32 | 10.255.1.8:10032 | 10032:10032 | - | - | learned |
| 3401 | 10.255.1.8:13401 | 13401:13401 | - | - | learned |
| 3402 | 10.255.1.8:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 10.255.1.8:10 | connected | - |
| VRF11 | 10.255.1.8:11 | connected | - |
| VRF13 | 10.255.1.8:13 | connected | - |
...
router bgp 65104
   ...
   neighbor MLAG-IPv6-UNDERLAY-PEER remote-as 65104
   neighbor MLAG-IPv6-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv6-UNDERLAY-PEER description leaf07
   ...
   neighbor 2001:db8:2:e::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:e::1 remote-as 65100
   neighbor 2001:db8:2:e::1 description spine01_Ethernet8
   neighbor 2001:db8:2:f::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:f::1 remote-as 65100
   neighbor 2001:db8:2:f::1 description spine02_Ethernet8
   neighbor 2001:db8:4:6::1 peer group MLAG-IPv6-UNDERLAY-PEER
   neighbor 2001:db8:4:6::1 description leaf07_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.8
      neighbor 2001:db8:4:6::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:6::1 description leaf07_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.8
      neighbor 2001:db8:4:6::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:6::1 description leaf07_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF13
      rd 10.255.1.8:13
      ...
      router-id 10.255.1.8
      neighbor 2001:db8:4:6::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:6::1 description leaf07_Vlan3012
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
ip address virtual source-nat vrf VRF13 address 10.255.13.8
```
