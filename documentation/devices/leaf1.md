...
| Ethernet5 | MLAG_leaf2_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_leaf2_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
!
interface Ethernet5
   description MLAG_leaf2_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf2_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| Port-Channel5 | MLAG_leaf2_Port-Channel5 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel5
   description MLAG_leaf2_Port-Channel5
   no shutdown
   switchport mode trunk
...
router bgp 65101
   ...
   vrf VRF13
      ...
      router-id 10.255.1.1
      neighbor 2001:db8:4::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4::2 description leaf2_Vlan3012
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
