...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_dc1-leaf3-server1_PCI1 | *trunk | *11-12,21-22 | *4092 | *- | 4 |
| Ethernet5 | MLAG_leaf4_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_leaf4_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_spine1_Ethernet3 | - | 2001:db8:2:4::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_spine2_Ethernet3 | - | 2001:db8:2:5::2/64 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet4
   description SERVER_dc1-leaf3-server1_PCI1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_leaf4_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf4_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| Port-Channel5 | MLAG_leaf4_Port-Channel5 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel5
   description MLAG_leaf4_Port-Channel5
   no shutdown
   switchport mode trunk
...
router bgp 65102
   ...
   vrf VRF13
      ...
      router-id 10.255.1.3
      neighbor 2001:db8:4:2::2 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::2 description leaf4_Vlan3012
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
