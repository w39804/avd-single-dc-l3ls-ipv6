...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_dc1-leaf3-server1_PCI2 | *trunk | *11-12,21-22 | *4092 | *- | 4 |
| Ethernet5 | MLAG_leaf3_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_leaf3_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_spine1_Ethernet4 | - | 2001:db8:2:6::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_spine2_Ethernet4 | - | 2001:db8:2:7::2/64 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet4
   description SERVER_dc1-leaf3-server1_PCI2
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_leaf3_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf3_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | SERVER_dc1-leaf3-server1 | trunk | 11-12,21-22 | 4092 | - | - | - | 4 | - |
| Port-Channel5 | MLAG_leaf3_Port-Channel5 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel4
   description SERVER_dc1-leaf3-server1
   no shutdown
...
interface Port-Channel5
   description MLAG_leaf3_Port-Channel5
   no shutdown
   switchport mode trunk
...
router bgp 65102
   ...
   neighbor MLAG-IPv6-UNDERLAY-PEER description leaf3
   ...
   neighbor 2001:db8:2:6::1 description spine1_Ethernet4
   neighbor 2001:db8:2:7::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:7::1 remote-as 65100
   neighbor 2001:db8:2:7::1 description spine2_Ethernet4
   neighbor 2001:db8:4:2::1 peer group MLAG-IPv6-UNDERLAY-PEER
   neighbor 2001:db8:4:2::1 description leaf3_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.4
      neighbor 2001:db8:4:2::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::1 description leaf3_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.4
      neighbor 2001:db8:4:2::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::1 description leaf3_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF13
      rd 10.255.1.4:13
      ...
      router-id 10.255.1.4
      neighbor 2001:db8:4:2::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:2::1 description leaf3_Vlan3012
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
