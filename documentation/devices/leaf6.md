...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | SERVER_dc1-leaf1-server1_iLO | access | 11 | - | - | - |
| Ethernet5 | MLAG_leaf5_Ethernet5 | *trunk | *- | *- | *MLAG | 5 |
| Ethernet6 | MLAG_leaf5_Ethernet6 | *trunk | *- | *- | *MLAG | 5 |
...
| --------- | ----------- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_spine1_Ethernet6 | - | 2001:db8:2:a::2/64 | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_spine2_Ethernet6 | - | 2001:db8:2:b::2/64 | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet5
   description MLAG_leaf5_Ethernet5
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description MLAG_leaf5_Ethernet6
   no shutdown
   channel-group 5 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_leaf5_Port-Channel5 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel5
   description MLAG_leaf5_Port-Channel5
   no shutdown
...
router bgp 65103
   ...
   neighbor MLAG-IPv6-UNDERLAY-PEER description leaf5
   ...
   neighbor 2001:db8:2:a::1 description spine1_Ethernet6
   neighbor 2001:db8:2:b::1 peer group IPv6-UNDERLAY-PEERS
   neighbor 2001:db8:2:b::1 remote-as 65100
   neighbor 2001:db8:2:b::1 description spine2_Ethernet6
   neighbor 2001:db8:4:4::1 peer group MLAG-IPv6-UNDERLAY-PEER
   neighbor 2001:db8:4:4::1 description leaf5_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.6
      neighbor 2001:db8:4:4::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:4::1 description leaf5_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.6
      neighbor 2001:db8:4:4::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:4::1 description leaf5_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF13
      rd 10.255.1.6:13
      ...
      router-id 10.255.1.6
      neighbor 2001:db8:4:4::1 peer group MLAG-IPv6-UNDERLAY-PEER
      neighbor 2001:db8:4:4::1 description leaf5_Vlan3012
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
